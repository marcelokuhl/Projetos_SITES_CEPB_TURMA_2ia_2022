...
function white() {
        ...
        document.getElementById('i1').setAttribute('style', 'color: burlywood !important;');
        document.getElementById('i2').setAttribute('style', 'color: burlywood !important;');
        document.getElementById('i3').setAttribute('style', 'color: burlywood !important;');
    ...
    function dark() {
        ...
        document.getElementById('i1').setAttribute('style', 'color: white !important;');
        document.getElementById('i2').setAttribute('style', 'color: white !important;');
        document.getElementById('i3').setAttribute('style', 'color: white !important;');
